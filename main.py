...
<SettingsScreen>:
    ...
    BoxLayout:
        ...
        Button:
            ...
            background_color: 0.1, 0.1, 0.1, 1
            font_size: 23
            on_release: app.root.current = "change_font"
        Button:
            id: saveandback_btn
            text: "Save and Back"
            background_color: 0.1, 0.1, 0.1, 1
...
<change_font>:
    ...
    BoxLayout:
        ...
        Button:
            text: "Arial"
            font_name: "Arial"
            on_press: root.change_to_arial()
            background_color: 0.1, 0.1, 0.1, 1
        Button:
            text: "Calibri"
            font_name: "Calibri"
            on_press: root.change_to_calibri()
            background_color: 0.1, 0.1, 0.1, 1
        Button:
            text: "Impact"
            font_name: "Impact"
            on_press: root.change_to_impact()
            background_color: 0.1, 0.1, 0.1, 1
        Button:
            text: "Modern 1"
            font_name: "Fonts\BouCollege.ttf"
            on_press: root.change_to_modern1()
            background_color: 0.1, 0.1, 0.1, 1
        Button:
            text: "Modern 2"
            font_name: "Fonts\Freshman.ttf"
            on_press: root.change_to_modern2()
            background_color: 0.1, 0.1, 0.1, 1
        Button:
            id: back_btn
            text: "<--- Back --->"
...
class MainScreen(Screen):
    ...
    def set_white_button(self, dt):
        ...
        self.ids.add_workout_btn.font_name = data["current_font"]
    def set_white_button2(self, dt):
        ...
        self.ids.view_workout_btn.font_name = data["current_font"]
    def set_white_button3(self, dt):
        ...
        self.ids.ach_btn.font_name = data["current_font"]
    def set_white_button4(self, dt):
        ...
        self.ids.settings_btn.font_name = data["current_font"]
...
class SettingsScreen(Screen):
    def on_enter(self):
            self.ids.white_mode_label.font_name = data["current_font"]
            self.ids.lbs_mode_label.font_name = data["current_font"]
            self.ids.font_size_btn.font_name = data["current_font"]
            self.ids.change_font_btn.font_name = data["current_font"]
            self.ids.saveandback_btn.font_name = data["current_font"]
            if data["white_mode"] == True:
            ...
            if data["white_mode"] is True:
                Clock.schedule_once(self.change_font_btn_set_white, 0)
            if data["white_mode"] is True:
            ...
            if data["white_mode"] is False:
                Clock.schedule_once(self.change_font_btn_set_black, 0)
            if data["white_mode"] is False:
    ...
    def change_font_btn_set_white(self, widget):
        btn = self.ids["change_font_btn"]
        btn.background_color = (1, 1, 1, 1)
        btn.background_normal = ''
        btn.color = (0, 0, 0, 1)
    ...
    def change_font_btn_set_black(self, widget):
        btn = self.ids["change_font_btn"]
        btn.background_color = (0, 0, 0, 1)
        btn.background_normal = ''
        btn.color = (1, 1, 1, 1)
...
class ViewWorkout(Screen):
    ...
    def ddo(self):
        ...
        self.ids.total_reps.font_name = data["current_font"]
        self.ids.total_reps.font_size = data["font_size"]

        self.ids.total_minutes.text = f"You have worked out a total of: {data["tot_min"]} minutes."
        self.ids.total_minutes.font_name = data["current_font"]
        self.ids.total_minutes.font_size = data["font_size"]

        if data["lbs_mode"] == True:
            self.ids.total_weight.text = f"You have lifted a total of: {data["tot_weight"] * 2} LBS."
            self.ids.total_weight.font_name = data["current_font"]
            self.ids.total_weight.font_size = data["font_size"]
        ...
        self.ids.total_workout_count.font_name = data["current_font"]
        self.ids.total_workout_count.font_size = data["font_size"]

        if data["tot_weight"] >= 20 and data["tot_weight"] <= 50:
            self.ids.comp_text.text = f"You've (In Total) Lifted a A Giant Pacific Octopus."
            self.ids.comp_text.font_name = data["current_font"]
            self.ids.comp_text.font_size = data["font_size"]
...
class change_font_screen(Screen):
    def on_enter(self):
        self.ids.f11.font_name = data["current_font"]
        self.ids.f12.font_name = data["current_font"]
        self.ids.f13.font_name = data["current_font"]
        self.ids.f14.font_name = data["current_font"]
        self.ids.f15.font_name = data["current_font"]
        self.ids.f16.font_name = data["current_font"]
        self.ids.f17.font_name = data["current_font"]
        self.ids.f18.font_name = data["current_font"]
        self.ids.f19.font_name = data["current_font"]
        self.ids.f20.font_name = data["current_font"]
        self.ids.f21.font_name = data["current_font"]
        self.ids.f22.font_name = data["current_font"]
        self.ids.f23.font_name = data["current_font"]
        self.ids.f24.font_name = data["current_font"]
        self.ids.f25.font_name = data["current_font"]
        self.ids.f26.font_name = data["current_font"]
        self.ids.f27.font_name = data["current_font"]
        self.ids.f28.font_name = data["current_font"]
        self.ids.f29.font_name = data["current_font"]
        self.ids.f30.font_name = data["current_font"]
        self.ids.back_btn.font_name = data["current_font"]
        if data["white_mode"] is True:
    ...
    def f30(self):
        ...
        with open("logs.json", "w") as file:
                json.dump(data, file)
class change_font(Screen):
    def on_enter(self):
        self.ids.back_btn.font_name = data["current_font"]
    def change_to_arial(self):
    ...
    def change_to_calibri(self):
        data["current_font"] = "Calibri"

        with open("logs.json", "w") as file:
                json.dump(data, file)

    def change_to_impact(self):
        data["current_font"] = "Impact"

        with open("logs.json", "w") as file:
                json.dump(data, file)
    
    def change_to_modern1(self):
        data["current_font"] = "Fonts\BouCollege.ttf"

        with open("logs.json", "w") as file:
                json.dump(data, file)
    
    def change_to_modern2(self):
        data["current_font"] = "Fonts\Freshman.ttf"
